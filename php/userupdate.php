...
if(isset($_POST['update'])){
    ...
    include"db.php";
    $sql=mysqli_query($conn,"UPDATE aisha_customer set fname='$fname',lname='$lname',address='$address',password='$password',email_address='$email_address',phone_nbr='$phone_nbr'");
    if($sql){
...
<?php
    if(isset($_POST['delete'])){
        ...
        $address=$_POST['address'];
        include"db.php";
    $sql=mysqli_query($conn,"DELETE from aisha_customer where id='$var' ");
    if($sql){
    echo"Your informations is deleted successfully";
    }
    else{
